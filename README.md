...
Next, we will explain the data description and the steps you may follow to solve this assignment.

## Solution steps :
It is  a binary classification problem statement with class-imbalance issue. 
It had been dealt with SMOTE+TOMEK and ADASYN.
